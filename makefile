...
LIBS += -lMemoryAllocators -lSystemDefaultMemoryAllocator -lSimpleMemoryAllocator
...
LIB_DIRS += -LMemoryAllocators -LMemoryAllocators/SystemDefault -LMemoryAllocators/Simple
